...
public class QEventInfo extends BeanPath<EventInfo> {
    ...
    private static final long serialVersionUID = 258633229L;
    ...
    public final DateTimePath<java.time.LocalDateTime> eventTicketingDate = createDateTime("eventTicketingDate", java.time.LocalDateTime.class);
